                ...
                <div className='col-sm-12  mx-auto'>
                    ...
                    <div className='row mx-auto'>
                        <div className='col-sm-6'>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Headers from email received</label>
                    ...
                    <div className='row mx-auto'>
                        <div className='col-sm-12 '>
                            <div className='mb-3'>
                                <label for="exampleFormControlTextarea1" class="form-label">Spamvertisement URLs</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                            </div>
                        </div>
                    </div>
